...
slMapCov :: HomOrientedSliced i h
...
slMapCnt :: HomOrientedSliced i h
...
-- | mapping of slices.
slMap :: (HomOrientedSliced i h, s ~ Dual (Dual s))
...
slfMapCov :: HomMultiplicativeSliced i h
...
slfMapCnt :: HomMultiplicativeSliced i h
...
slfMap :: (HomMultiplicativeSliced i h, s ~ Dual (Dual s))
...
instance (HomMultiplicativeSliced i h, s ~ Dual (Dual s))
  => ApplicativeG (SDualBi (SliceFactor s i)) h (->) where
  amapG = slfMap

instance (HomMultiplicativeSliced i h, FunctorialOriented h, s ~ Dual (Dual s))
