...
-- | bi-structural duality given by a functorial from @'SDualCat' __o h__@ to @__c__@ according to
-- @'SDual' __a b__@.
class (Transformable1 o s, FunctorialG (SDual a b) (SDualCat s o h) c)
