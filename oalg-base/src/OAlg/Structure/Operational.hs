...
--     evaluation will end up in a 'OAlg.Structure.Exception.NotApplicable' or
--     'OAlg.Structure.Exception.NotApplicable.NotMultiplicable' exception.
--
...
--     evaluation will end up in a 'OAlg.Structure.Exception.NotApplicable.NotApplicable' or
--     'OAlg.Structure.Exception.NotApplicable.NotMultiplicable' exception.
--
